            ...
            <nav class="site-navigation position-relative text-left" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none pl-0 d-lg-block border-none">
                ...
                <li class="active"><a href="products.php" class="nav-link text-left"><b>Products</b></a>
                 <ul>
                 <li><a href="brother.php?b1=tonercartridge">Toner Cartridge</a></li>
                  <li><a href="brother.php?b2=inkcartridge">Ink Cartridge</a></li>
                </ul></li>
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-12 section-title text-center mb-5">
            <h2 class="d-block">BRAND : BROTHER</h2>
          </div>
        </div>

        <div class="row">
        <?php
           $productNameB1 = "toner cartridge";
           $productNameB2 = "ink cartridge";

           if(isset($_GET['b1']) == "tonercartridge")  
           $sqlSelProd = mysql_query("select * from brother where b_type = '$productNameB1' ") or die(mysql_error()); 
           else if(isset($_GET['b2']) == "inkcartridge") 
           $sqlSelProd = mysql_query("select * from brother where b_type = '$productNameB2' ") or die(mysql_error());
           else
           $sqlSelProd = mysql_query("select * from brother") or die(mysql_error());
          ...
          if(mysql_num_rows($sqlSelProd) >= 1)
          {
             ...
             { ?>
              ...
              <a href="brother.php" class="thumbnail d-block mb-4"><img src= <?php echo "EntregreenAdmin/Upload/brother/". $getRowSearchProduct['bimage_location'] ?> alt="Image" class="img-fluid" style="width:200px;height: 120px"></a>
              <div>
