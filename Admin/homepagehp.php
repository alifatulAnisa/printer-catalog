                   ...
                   <?php
                    ...
                    $result = mysql_query($sql) or die('Query failed. ' . mysql_error());
                     ...
                     while($row = mysql_fetch_assoc($result)) {?>
                        ...
                        <th scope="row"></th>
                        <td class="tm-product-name"><?php echo $row['hp_model'] ?></td>
                        <td><?php echo $row['hp_type'] ?></td>
                        <td><?php echo $row['hp_colour'] ?></td>
                        <td><?php echo $row['hp_ds'] ?></td>
                        <td><?php echo $row['hp_price'] ?></td>
                    <td>

                      <a href="delete.php?deletedhp=1&hp_id=<?php echo $row['hp_id'] ?>" class="tm-product-delete-link" onclick="return confirm ('Are you sure want to delete?');">
                        <i class="far fa-trash-alt tm-product-delete-icon"></i>
                        <a href="edithp.php?editedhp=1&hp_id=<?php echo $row['hp_id'] ?>" class="tm-product-delete-link">
