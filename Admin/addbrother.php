  ...
  <body>
    <nav class="navbar navbar-expand-xl">
      <div class="container h-100">
        <a class="navbar-brand" href="homepagebrother.php">
                ...
                <form action="add-product.php" enctype="multipart/form-data" method="post" class="tm-edit-product-form">
                  ...
                  <div class="form-group mb-3">
                    ...
                    >
                      ...
                      <option value="YellowMagentaCyan">Yellow Magenta Cyan</option>
                    </select>
                  </div>
                  <!--end colour-->
                  <!--description-->
...
<!-- image prview -->
              ...
              <div class="col-12">
                <button input type="submitbrother" name="submitbrother" class="btn btn-primary btn-block text-uppercase">Add Product Now</button>
              </div>
            </form>
            </div>
          </div>
