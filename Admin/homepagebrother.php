    ...
    <nav class="navbar navbar-expand-xl">
      <div class="container h-100">
        <a class="navbar-brand" href="index.html">
          <h1 class="tm-site-title mb-0">Product : BROTHER </h1>
        </a>
        <button
                   ...
                   <?php
                    ...
                    $result = mysql_query($sql) or die('Query failed. ' . mysql_error());
                     ...
                     while($row = mysql_fetch_assoc($result)) {?>
                        ...
                        <th scope="row"></th>
                        <td class="tm-product-name"><?php echo $row['b_model'] ?></td>
                        <td><?php echo $row['b_type'] ?></td>
                        <td><?php echo $row['b_colour'] ?></td>
                        <td><?php echo $row['b_ds'] ?></td>
                        <td><?php echo $row['b_price'] ?></td>
                    <td>

                      <a href="delete.php?deletedbrother=1&b_id=<?php echo $row['b_id'] ?>" class="tm-product-delete-link" onclick="return confirm ('Are you sure want to delete?');">
                        <i class="far fa-trash-alt tm-product-delete-icon"></i>
                        <a href="editbrother.php?editedbrother=1&b_id=<?php echo $row['b_id'] ?>" class="tm-product-delete-link">
