  ...
  <body>
    <nav class="navbar navbar-expand-xl">
      <div class="container h-100">
        <a class="navbar-brand" href="homepagecanon.php">
...
<!-- image prview -->
              ...
              <!--end image-->
              <div class="col-12">
                <button input type="submitcanon" name="submitcanon" class="btn btn-primary btn-block text-uppercase">Add Product Now</button>
              </div>
            </form>
            </div>
          </div>
