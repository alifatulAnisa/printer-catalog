  ...
  <body>
    <nav class="navbar navbar-expand-xl">
      <div class="container h-100">
        <a class="navbar-brand" href="homepageepson.html">
        ...
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <form action="add-product.php" enctype="multipart/form-data" method="post" class="tm-edit-product-form">
                  ...
                  <div class="form-group mb-3">
                    ...
                    >
                    <select
                      class="custom-select tm-select-accounts" name="e_colour"
                      id="e_colour"
                    >
              ...
              <!--end image-->
              <div class="col-12">
                <button input type="submitepson" name="submitepson" class="btn btn-primary btn-block text-uppercase">Add Product Now</button>
              </div>
            </form>
            </div>
          </div>
