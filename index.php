...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <a href="login.php" class="cust btn1"><span style="width: 50px;" class="icon-shopping-bag mr-3"></span>Login</a>
   ...
   <input type="text" name="keyword" placeholder="Search for Model..." name="search2">
          ...
          <div class="mx-auto">
            <nav class="site-navigation position-relative text-left" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none pl-0 d-lg-block border-none">
               ...
               <li class="active"><a href="index.php" class="nav-link text-left"><b>Home</b></a></li>
...
$(function () {
  ...
  <!-- start: Hero Unit - Main hero unit for a primary marketing message or call to action -->
          <div class="hero-unit">
            <p>
         Launched in February, 2002 with a goal to provide premium compatible cartridges at reasonable prices, as a cost-effective alternative to Original Equipment Manufacturer (OEM) products.
        </p>
      ...
      <div class="container">
        <div class="owl-carousel owl-slide-3 owl-slide">
          ...
          <blockquote class="testimony">
            <img src="images/right.png" alt="Image">
            <p>We are provide printer from original, oem part, and ciss based on our customer. We sale and rent the printer including service for rental printer.</p>
           
          </blockquote>
          <blockquote class="testimony">
            <img src="images/right.png" alt="Image">
            <p>We provide the best service and maintanance from time to time
              Network management refers to the broad subject of managing computer networks. </p>
           
          </blockquote>
          <blockquote class="testimony">
            <img src="images/right.png" alt="Image">
            <p>A variety of software and hardware products that help network system administrators manage a network.</p>
