            ...
            <nav class="site-navigation position-relative text-left" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none pl-0 d-lg-block border-none">
                ...
                <li class="active"><a href="products.php" class="nav-link text-left"><b>Products</b></a>
                 <ul>
                 <li><a href="canon.php?c1=tonercartridge">Toner Cartridge</a></li>
                  <li><a href="canon.php?c2=inkcartridge">Ink Cartridge</a></li>
                </ul></li>
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-12 section-title text-center mb-5">
            <h2 class="d-block">BRAND : CANON</h2>
          </div>
        </div>

        <div class="row">
              <?php
           $productNameC1 = "toner cartridge";
           $productNameC2 = "ink cartridge";

           if(isset($_GET['c1']) == "tonercartridge")  
           $sqlSelProd = mysql_query("select * from canon where c_type = '$productNameC1' ") or die(mysql_error()); 
           else if(isset($_GET['c2']) == "inkcartridge") 
           $sqlSelProd = mysql_query("select * from canon where c_type = '$productNameC2' ") or die(mysql_error());
 
           else
           $sqlSelProd = mysql_query("select * from canon") or die(mysql_error());
          ...
          if(mysql_num_rows($sqlSelProd) >= 1)
          {
             ...
             { ?>
              ...
              <a href="canon.php" class="thumbnail d-block mb-4"><img src= <?php echo "EntregreenAdmin/Upload/canon/". $getRowSearchProduct['cimage_location'] ?> alt="Image" class="img-fluid" style="width:200px;height: 150px"></a>
              <div>
              <h3 class="heading mb-1"><a href="#">Model : <?php echo $getRowSearchProduct['c_model'] ?></a></h3>
              <h3 class="heading mb-1"><a href="#">Type : <?php echo $getRowSearchProduct['c_type'] ?></a></h3>
             ...
             <div class="product-actions">             
                <a href="https://wa.me/60135122507" class="btn btn1"><span class="icon-shopping-bag mr-3"></span>Shop</a>
              </div>
              </div>
              </div>
             <?php  } } ?>
