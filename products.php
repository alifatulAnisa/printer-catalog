...
include('functions.php'); 
    ...
    /*if ($conn){
      ...
      if ($db){
        echo 'Successfully found database.';
      }else{
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 col-md-6">
            <div class="wine_v_1 text-center pb-4">
              ...
              <a href="hp.php" class="thumbnail d-block mb-4"><img src="images/HP/hp.png" alt="Image" class="img-fluid"></a>
              <div class="product-actions">             
                <a href="hp.php" class="btn btn1"><span class="icon-shopping-bag mr-3"></span>View All</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 mb-5 col-md-6">
            <div class="wine_v_1 text-center pb-4">
              <a href="brother.php" class="thumbnail d-block mb-4"><img src="images/BROTHER/brother.png" alt="Image" class="img-fluid"></a>
              <div class="product-actions">             
                <a href="brother.php" class="btn btn1"><span class="icon-shopping-bag mr-3"></span>View All</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 mb-5 col-md-6">
            <div class="wine_v_1 text-center pb-4">
              <a href="canon.php" class="thumbnail d-block mb-4"><img src="images/CANON/canon.png" alt="Image" class="img-fluid"></a>
              <div class="product-actions">             
                <a href="canon.php" class="btn btn1"><span class="icon-shopping-bag mr-3"></span>View All</a>
              </div>
            </div>
          </div>
